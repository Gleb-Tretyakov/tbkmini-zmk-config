...
- Восемью слоями для символов, навигации, функций и управления мышью
...
- Интеграцией трекбола для управления курсором мыши
...
Слой для управления курсором мыши через трекбол:
- Кнопки мыши (левая, правая, средняя)
- Движение курсора (вверх, вниз, влево, вправо)
- Прокрутка колесика мыши
- Дополнительные кнопки мыши (кнопки 4 и 5)
...
Слой MOUSE активируется отдельно и не входит в основную группу клавиш под большие пальцы.

### Как использовать новые функции

#### Слой MOUSE
Слой MOUSE предназначен для управления курсором мыши через трекбол. Чтобы активировать этот слой:
- Используйте соответствующую клавишу или комбинацию клавиш (зависит от настройки прошивки)
- После активации слоя используйте клавиши для управления курсором и кнопками мыши
- Для возврата к предыдущему слою отпустите клавишу активации или используйте специальную клавишу выхода
...
Раскладка включает интеграцию трекбола для управления курсором мыши через отдельный слой MOUSE:
...
2. **Интеграция трекбола**: Добавлена функциональность трекбола/мыши в отдельный слой MOUSE
...
7. **Восемь слоев**: Добавлен слой MOUSE для управления курсором мыши
